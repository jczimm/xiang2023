...
Specifically, I will attempt to replicate that A) when rounds 1 and 2 feature no individual success, participants still judge the probability of joint success in round 3 as non-zero. In addition, I will attempt to qualitatively replicate that B) participants judge higher probability of joint success as cases of individual success increases, and that the proposed model is the only model evaluated which predicts both patterns A and B (see original paper's Figure 3C and accompanying explanation, pp. 1570-1571; I will recreate that figure and attempt to replicate that explanation on my own data). I will also estimate and statistically test the difference in the probability judgments plotted in Figure 3C between the original data and my new data.
